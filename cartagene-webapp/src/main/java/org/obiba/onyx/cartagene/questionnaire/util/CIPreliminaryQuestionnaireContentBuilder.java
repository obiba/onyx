...
public class CIPreliminaryQuestionnaireContentBuilder {
  ...
  public static QuestionnaireBuilder buildCIPreliminaryQuestionnaire() {
    ...
    builder.inSection("S1_PARTICIPANT").withPage("2").withQuestion("S1_BP2");
    ...
    builder.inSection("S1_PARTICIPANT").withPage("3").withQuestion("LAST_MEAL_WHEN"/* , "3" */).withSharedCategory(TIME_24).withOpenAnswerDefinition(TIME_24, DataType.DATE).withOpenAnswerDefinition("HOUR_24", DataType.INTEGER).setDefaultData(DataBuilder.buildInteger(0), DataBuilder.buildInteger(1), DataBuilder.buildInteger(2), DataBuilder.buildInteger(3), DataBuilder.buildInteger(4), DataBuilder.buildInteger(5), DataBuilder.buildInteger(6), DataBuilder.buildInteger(7), DataBuilder.buildInteger(8), DataBuilder.buildInteger(9), DataBuilder.buildInteger(10), DataBuilder.buildInteger(11), DataBuilder.buildInteger(12), DataBuilder.buildInteger(13), DataBuilder.buildInteger(14), DataBuilder.buildInteger(15), DataBuilder.buildInteger(16), DataBuilder.buildInteger(17), DataBuilder.buildInteger(18), DataBuilder.buildInteger(19), DataBuilder.buildInteger(20), DataBuilder.buildInteger(21), DataBuilder.buildInteger(22), DataBuilder.buildInteger(23));
    builder.inOpenAnswerDefinition(TIME_24).withOpenAnswerDefinition("MINUTE_15", DataType.INTEGER).setDefaultData(DataBuilder.buildInteger(0), DataBuilder.buildInteger(15), DataBuilder.buildInteger(30), DataBuilder.buildInteger(45));
