...
public class CIPreliminaryQuestionnaireContentBuilder {
  ...
  public static QuestionnaireBuilder buildCIPreliminaryQuestionnaire() {
    ...
    builder.inCondition("BD_LEFT_POSSIBLE_MCONDITION_1_2_2_2").withAnswerCondition("BD_LEFT_POSSIBLE_ACONDITION_8", "RIGHT_LOWER_EXTREMITY_FRACTURE_5_YEARS", Y);
    builder.inCondition("BD_LEFT_POSSIBLE_MCONDITION_1_2_2_2").withAnswerCondition("BD_LEFT_POSSIBLE_ACONDITION_9", "RIGHT_LOWER_EXTREMITY_IMPLANT_5_YEARS", Y);
    builder.inCondition("BD_LEFT_POSSIBLE_MCONDITION_1_2_2_2").withAnswerCondition("BD_LEFT_POSSIBLE_ACONDITION_10", "RIGHT_LOWER_EXTREMITY_INJURY_1_MONTH", Y);
