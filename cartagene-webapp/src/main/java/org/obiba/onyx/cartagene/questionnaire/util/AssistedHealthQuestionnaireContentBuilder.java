...
public class AssistedHealthQuestionnaireContentBuilder {
  ...
  public static QuestionnaireBuilder buildHealthQuestionnaire() {
    ...
    builder.inPage("9").withQuestion("RX_MEDICATION").withCategory("MED_NUMBER").withOpenAnswerDefinition("MED_NUMBER", DataType.INTEGER).addValidator(new NumberValidator.RangeValidator(0, 3));
    ...
    builder.inPage("9").withQuestion("MEDICATION1_TYPE").withSharedCategory(TYPE).withOpenAnswerDefinition(TYPE, DataType.TEXT);
    ...
    builder.inPage("9").withQuestion("MED1_TYPE_INFO_SOURCE").withSharedCategory(PACKAGE, "0");
    ...
    builder.inPage("9").withQuestion("MEDICATION2_TYPE").withSharedCategory(TYPE);
    ...
    builder.inPage("9").withQuestion("MED2_TYPE_INFO_SOURCE").withSharedCategory(PACKAGE, "0");
    ...
    builder.inPage("9").withQuestion("MEDICATION3_TYPE").withSharedCategory(TYPE);
    ...
    builder.inPage("9").withQuestion("MED3_TYPE_INFO_SOURCE").withSharedCategory(PACKAGE, "0");
    ...
    builder.inPage("9").addTimestamp("TS_VMH");
