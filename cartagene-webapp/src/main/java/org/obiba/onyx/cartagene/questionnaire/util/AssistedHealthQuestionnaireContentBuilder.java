...
public class AssistedHealthQuestionnaireContentBuilder {
  ...
  public static QuestionnaireBuilder buildHealthQuestionnaire() {
    ...
    builder.inQuestion("WORK_VIGOROUS_ACTIVITY_TIME_DAY").setDataCondition("WORK_VIGOROUS_ACTIVITY_TIME_DAY_DCONDITION", "WORK_VIGOROUS_ACTIVITY_DAYS_WEEK", "DAYS_WEEK", "DAYS_WEEK", ComparisonOperator.gt, DataBuilder.buildInteger(0l));
    ...
    builder.inQuestion("NUMBER_LIVE_BIRTHS").setDataCondition("NUMBER_LIVE_BIRTHS_DCONDITION", "NUMBER_PREGNANCIES_ALL", OPEN_N_0, OPEN_N_0, ComparisonOperator.gt, DataBuilder.buildInteger(0l));
    ...
    builder.inQuestion("NEO_FIRST_DEG_REL_NUMBER").setMultipleCondition("NEO_FIRST_DEG_REL_NUMBER_MCONDITION", ConditionOperator.OR).withDataCondition("NEO_FIRST_DEG_REL_NUMBER_DCONDITION_0", "HealthQuestionnaireSelfAdministered", "NUMBER_SIBLINGS_ALL", OPEN_N, OPEN_N, ComparisonOperator.gt, DataBuilder.buildInteger(0l));
    builder.inCondition("NEO_FIRST_DEG_REL_NUMBER_MCONDITION").withDataCondition("NEO_FIRST_DEG_REL_NUMBER_DCONDITION_1", "NUMBER_LIVE_BIRTHS", OPEN_N_0, OPEN_N_0, ComparisonOperator.gt, DataBuilder.buildInteger(0l));
    builder.inCondition("NEO_FIRST_DEG_REL_NUMBER_MCONDITION").withDataCondition("NEO_FIRST_DEG_REL_NUMBER_DCONDITION_2", "NUMBER_CHILDREN_FATHERED", OPEN_N_0, OPEN_N_0, ComparisonOperator.gt, DataBuilder.buildInteger(0l));
    builder.inQuestion("NEO_FIRST_DEG_REL_NUMBER").withQuestion("NEOPLASM_NUMBER_SIBLINGS", "1.3");
    builder.inQuestion("NEOPLASM_NUMBER_SIBLINGS").setDataCondition("NEOPLASM_NUMBER_SIBLINGS_DCONDITION", "HealthQuestionnaireSelfAdministered", "NUMBER_SIBLINGS_ALL", OPEN_N, OPEN_N, ComparisonOperator.gt, DataBuilder.buildInteger(0l));
    builder.inQuestion("NEO_FIRST_DEG_REL_NUMBER").withQuestion("NEOPLASM_NUMBER_CHILDREN", "1.4");
    builder.inQuestion("NEOPLASM_NUMBER_CHILDREN").setMultipleCondition("NEOPLASM_NUMBER_CHILDREN_MCONDITION", ConditionOperator.OR).withDataCondition("NEOPLASM_NUMBER_CHILDREN_DCONDITION_0", "NUMBER_LIVE_BIRTHS", OPEN_N_0, OPEN_N_0, ComparisonOperator.gt, DataBuilder.buildInteger(0l));
    builder.inCondition("NEOPLASM_NUMBER_CHILDREN_MCONDITION").withDataCondition("NEOPLASM_NUMBER_CHILDREN_DCONDITION_1", "NUMBER_CHILDREN_FATHERED", OPEN_N_0, OPEN_N_0, ComparisonOperator.gt, DataBuilder.buildInteger(0l));
    ...
    builder.inQuestion("FHD03").setDataCondition("FHD03_ACONDITION", "NEOPLASM_NUMBER_SIBLINGS", OPEN_N, OPEN_N, ComparisonOperator.gt, DataBuilder.buildInteger(0l));
    ...
    builder.inQuestion("NEOPLASM_TYPE_SIB1").setDataCondition("NEOPLASM_TYPE_SIB1_DCONDITION", "NEOPLASM_NUMBER_SIBLINGS", OPEN_N, OPEN_N, ComparisonOperator.gt, DataBuilder.buildInteger(0l));
    ...
    builder.inQuestion("NEOPLASM_AGE_SIB1").setDataCondition("NEOPLASM_AGE_SIB1_DCONDITION", "NEOPLASM_NUMBER_SIBLINGS", OPEN_N, OPEN_N, ComparisonOperator.gt, DataBuilder.buildInteger(0l));
    ...
    builder.inQuestion("BIRTH_RANK_SIB1").setDataCondition("BIRTH_RANK_SIB1_DCONDITION", "NEOPLASM_NUMBER_SIBLINGS", OPEN_N, OPEN_N, ComparisonOperator.gt, DataBuilder.buildInteger(0l));
    ...
    builder.inQuestion("NEOPLASM_TYPE_SIB2").setDataCondition("NEOPLASM_TYPE_SIB2_DCONDITION", "NEOPLASM_NUMBER_SIBLINGS", OPEN_N, OPEN_N, ComparisonOperator.gt, DataBuilder.buildInteger(1l));
    ...
    builder.inQuestion("NEOPLASM_AGE_SIB2").setDataCondition("NEOPLASM_AGE_SIB2_DCONDITION", "NEOPLASM_NUMBER_SIBLINGS", OPEN_N, OPEN_N, ComparisonOperator.gt, DataBuilder.buildInteger(1l));
    ...
    builder.inQuestion("BIRTH_RANK_SIB2").setDataCondition("BIRTH_RANK_SIB2_DCONDITION", "NEOPLASM_NUMBER_SIBLINGS", OPEN_N, OPEN_N, ComparisonOperator.gt, DataBuilder.buildInteger(1l));

    builder.inSection("NEOPLASMS").withPage("20").withQuestion("FHD04");
    builder.inQuestion("FHD04").setDataCondition("FHD04_DCONDITION", "NEOPLASM_NUMBER_CHILDREN", OPEN_N, OPEN_N, ComparisonOperator.gt, DataBuilder.buildInteger(0l));
    ...
    builder.inQuestion("NEOPLASM_TYPE_CHILD1").setDataCondition("NEOPLASM_TYPE_CHILD1_DCONDITION", "NEOPLASM_NUMBER_CHILDREN", OPEN_N, OPEN_N, ComparisonOperator.gt, DataBuilder.buildInteger(0l));
    ...
    builder.inQuestion("NEOPLASM_AGE_CHILD1").setDataCondition("NEOPLASM_AGE_CHILD1_DCONDITION", "NEOPLASM_NUMBER_CHILDREN", OPEN_N, OPEN_N, ComparisonOperator.gt, DataBuilder.buildInteger(0l));
    ...
    builder.inQuestion("BIRTH_RANK_CHILD1").setDataCondition("BIRTH_RANK_CHILD1_DCONDITION", "NEOPLASM_NUMBER_CHILDREN", OPEN_N, OPEN_N, ComparisonOperator.gt, DataBuilder.buildInteger(0l));
    ...
    builder.inQuestion("NEOPLASM_TYPE_CHILD2").setDataCondition("NEOPLASM_TYPE_CHILD2_DCONDITION", "NEOPLASM_NUMBER_CHILDREN", OPEN_N, OPEN_N, ComparisonOperator.gt, DataBuilder.buildInteger(1l));
    ...
    builder.inQuestion("NEOPLASM_AGE_CHILD2").setDataCondition("NEOPLASM_AGE_CHILD2_DCONDITION", "NEOPLASM_NUMBER_CHILDREN", OPEN_N, OPEN_N, ComparisonOperator.gt, DataBuilder.buildInteger(1l));
    ...
    builder.inQuestion("BIRTH_RANK_CHILD2").setDataCondition("BIRTH_RANK_CHILD2_DCONDITION", "NEOPLASM_NUMBER_CHILDREN", OPEN_N, OPEN_N, ComparisonOperator.gt, DataBuilder.buildInteger(1l));
