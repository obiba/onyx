...
public class SelfAdminHealthQuestionnaireContentBuilder {
  ...
  public static QuestionnaireBuilder buildHealthQuestionnaire() {
    ...
    builder.withSection("A_ADMINISTRATION").withSection("ADMINISTRATIVE_DATA").withPage("1").withQuestion("A0", "1");
    ...
    builder.inSection("B_DEMOGRAPHY").withSection("LANGUAGE").withPage("22").withQuestion("FIRST_LANGUAGE_LEARNED", "21", true).withCategory("ENGLISH").setExportName("1");
