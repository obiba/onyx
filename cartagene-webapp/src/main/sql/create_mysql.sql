...
create table action (id bigint not null auto_increment, comment varchar(255), date_time datetime, event_reason varchar(255), type varchar(255), user_id bigint, interview_id bigint, stage_id bigint, primary key (id)) type=InnoDB;
create table an_entity (id bigint not null auto_increment, name varchar(255), primary key (id)) type=InnoDB;
...
create table input_source (input_source_type varchar(31) not null, id bigint not null auto_increment, parameter_name varchar(200), value varchar(200), property varchar(200), instrument_type_id bigint, primary key (id)) type=InnoDB;
...
create table instrument_run (id bigint not null auto_increment, refusal_reason varchar(255), refusal_reason_comment text, status varchar(255), time_end datetime, time_start datetime, user_id bigint, instrument_id bigint, participant_interview_id bigint, primary key (id)) type=InnoDB;
create table instrument_run_value (id bigint not null auto_increment, boolean_value bit, capture_method varchar(255), data_value blob, date_value datetime, decimal_value double precision, integer_value bigint, text_value text, value_integrity varchar(255), instrument_run_id bigint, instrument_parameter_id bigint, primary key (id)) type=InnoDB;
...
create table interview (id bigint not null auto_increment, closed bit, start_date datetime, status varchar(255), stop_date datetime, user_id bigint, participant_id bigint, primary key (id)) type=InnoDB;
...
create table stage_execution_memento (id bigint not null auto_increment, state varchar(255), stage_id bigint, interview_id bigint, primary key (id)) type=InnoDB;
