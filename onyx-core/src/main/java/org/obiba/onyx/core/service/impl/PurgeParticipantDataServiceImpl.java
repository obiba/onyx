...
public class PurgeParticipantDataServiceImpl implements PurgeParticipantDataService {
  ...
  private boolean multipleInterview;
  ...
  public boolean isMultipleInterview() {
    return multipleInterview;
  }

  public void setMultipleInterview(boolean multipleInterview) {
    this.multipleInterview = multipleInterview;
  }
}
