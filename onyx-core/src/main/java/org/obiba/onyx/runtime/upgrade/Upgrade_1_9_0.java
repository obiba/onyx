...
public class Upgrade_1_9_0 extends AbstractUpgradeStep {
  ...
  private static final String UPDATE_USER_NAME
      = "UPDATE :table AS t, user AS u SET t.user_name=u.login WHERE t.user_id=u.id;";

  private static final String[] TABLES = { "action", "questionnaire_participant", "instrument_run", "measure",
  ...
  public void execute(Version currentVersion) {
    ...
    int roles = jdbcTemplate
        .queryForObject(ROLE_EXISTS, ImmutableMap.of("role", Role.PARTICIPANT_RECEPTIONIST.getName()), Integer.class);
    if(roles < 1) {
