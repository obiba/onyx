...
public class FdfProducer {
  ...
  protected void buildReplaceContext(String acceptUrl, String refuseUrl) {
    ...
    replaceContext.put("User", userService.getUserWithLogin(activeInterviewService.getOperator()));
    ...
    for(String fieldName : fields.keySet()) {
      ...
      if(fieldValue != null) {
        if(isFieldPushButton(acroFields.getFieldType(fieldName))) {
          ...
          log.info("Setting field {} with value of type {}", new Object[] { fieldName, fieldValue.getClass().getName() });
