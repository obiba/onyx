...
public class Tbf310InstrumentRunner extends AbstractInstrumentRunner implements SerialPortEventListener {
  ...
  public Tbf310InstrumentRunner() throws Exception {
    ...
    saveDataBtn.setToolTipText("Sauvegarder les mesures et retourner � l'interface CaG");
  ...
  private void reestablishConnection() {
    ...
    while(serialPort == null || !serialPort.isCTS()) {
      ...
      wConfirmation = JOptionPane.showConfirmDialog(appWindow, "La communication n'a pu �tre �tablie\n" + "avec l'appareil de bioimp�dance!\n\n" + "V�rifiez si les c�bles sont bien\n" + "branch�s et appuyer ensuite sur OK.", "Probl�me de communication", JOptionPane.OK_CANCEL_OPTION);
  ...
  private void setTanitaData(String[] pOutputData) {
    ...
    if(wBodyTypeCode.endsWith("0")) {
      ...
      bodyTypeTxt.setText("Athl�tique");
    }
  ...
  public void serialEvent(SerialPortEvent pEvent) {
    ...
    case SerialPortEvent.DATA_AVAILABLE:
      ...
      try {
        ...
        JOptionPane.showMessageDialog(appWindow, "Une erreur s'est produite lors de la communication\n" + "des r�sultats par l'appareil de bioimp�dance." + "Veuillez reprendre les mesures SVP.", "Erreur de communication", JOptionPane.ERROR_MESSAGE);
      }
  ...
  protected JPanel buildMainPanel() {
    ...
    addDataField(impedanceTxt, wResultPanel, "R�sistance :", " \u03A9");
    ...
    addDataField(ageTxt, wResultPanel, "�ge :", " ans");
  ...
  private void confirmOnExit() {
    ...
    if(saveDataBtn.isEnabled()) {
      ...
      int wConfirmation = JOptionPane.showConfirmDialog(appWindow, "Voulez-vous vraiment fermer cette fen�tre?\n" + "(les donn�es affich�es seront perdues)", "Confirmation", JOptionPane.YES_NO_OPTION);
