...
public class MiniSpirInstrumentRunnerTest {
  ...
  private void setExpectedOutputParameterNames() {
    String elements[] = { "OUTPUT_PARTICIPANT_LAST_NAME", "OUTPUT_PARTICIPANT_FIRST_NAME", "OUTPUT_PARTICIPANT_BIRTH_DATE", "OUTPUT_PARTICIPANT_GENDER", "RES_MEASURED_FVC", "RES_MEASURED_FEV1", "RES_MEASURED_FEV1_FVC", "RES_MEASURED_FEV6", "RES_MEASURED_FEV1_FEV6", "RES_MEASURED_PEF", "RES_MEASURED_FEF2575", "RES_MEASURED_FEV3", "RES_MEASURED_FEV3_FVC", "RES_MEASURED_ELA", "RES_MEASURED_FET", "RES_MEASURED_FEF25", "RES_MEASURED_FEF50", "RES_MEASURED_FEF75", "RES_MEASURED_EVOL", "RES_MEASURED_FIVC", "RES_MEASURED_FIV1", "RES_MEASURED_FIV1_FIVC", "RES_MEASURED_PIF", "RES_PRED_FVC", "RES_PRED_FEV1", "RES_PRED_FEV1_FVC", "RES_PRED_FEV6", "RES_PRED_FEV1_FEV6", "RES_PRED_PEF", "RES_PRED_FEF2575", "RES_PRED_FEV3", "RES_PRED_FEV3_FVC", "RES_PRED_ELA", "RES_PRED_FET", "RES_PRED_FEF25", "RES_PRED_FEF50", "RES_PRED_FEF75", "RES_PRED_EVOL", "RES_PRED_FIVC", "RES_PRED_FIV1", "RES_PRED_FIV1_FIVC", "RES_PRED_PIF", "RES_FVC_IMAGE" };
