...
public class InstrumentManualOutputParameterPanel extends Panel {
  ...
  public InstrumentManualOutputParameterPanel(String id, final int tableBodyHeight) {
    ...
    if(!instrumentType.hasManualCaptureOutputParameters()) {
  ...
  private class OutputFragment extends Fragment {
    ...
    public OutputFragment(String id) {
      ...
      for(InstrumentOutputParameter param : activeInstrumentRunService.getInstrumentType().getManualCaptureOutputParameters()) {
