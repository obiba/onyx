 ...
 ******************************************************************************/
package org.obiba.onyx.quartz.editor.behavior.syntaxHighlighter;
...
public class SyntaxHighlighterBehavior extends AttributeModifier {
  ...
  public SyntaxHighlighterBehavior(IModel<String> language, Map<String, Object> config) {
  ...
  public SyntaxHighlighterBehavior() {
    this(null, null); // auto detect language
  }
  ...
  public void renderHead(IHeaderResponse response) {
    ...
    response.renderJavascript("$.SyntaxHighlighter.init({ " + configuration + " });", "SyntaxHighlighter");
  }
