 ...
 * </p>
 * <ul>
 * <li>v2.2.2 - Fixed encodeFileToFile and decodeFileToFile to use the Base64.InputStream class to encode and decode on
 * the fly which uses less memory than encoding/decoding an entire file into memory before writing.</li>
