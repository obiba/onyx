...
public class SelfAdminHealthQuestionnaireContentBuilder {
  ...
  public static QuestionnaireBuilder buildQuestionnaire() {
    ...
    builder.inSection("B_DEMOGRAPHY").withSection("SIBLING").withPage("5").withQuestion("NUMBER_SIBLINGS_ALL", "5").withSharedCategory(OPEN_N).withOpenAnswerDefinition(OPEN_N, DataType.INTEGER).addValidator(new MinimumValidator(0l));
